// // based on https://github.com/luwes/sinuous/blob/master/packages/sinuous/map/src/diff.js
//
// export const DELETE_OPERATION = -1
//
// export function diff(parent: Node, a: (Node | null)[], b: Node[], get: (node: Node, ), before?: Node): Node[] {
// 	const aIdx = new Map()
// 	const bIdx = new Map()
// 	let i
// 	let j
